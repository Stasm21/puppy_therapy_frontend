...
const RenterProfile = (props) => {
  ...
  useEffect(() => {
    axios.get(`${apiUrl}/api/renterReviews/`).then((res) => {
          ...
          >
            {!userReviews ||
              (userReviews.length == 0 && (
                <Typography variant="h3">
                  You've Not Posted Any Reviews Yet
                </Typography>
              ))}
            {userReviews.map((review) => (
              <ReviewCard
                ...
                profileSlug={review?.owner?.user?.username}
        ...
        >
          ...
          {userInfo?.latitude && userInfo?.longitude ? (
            ...
            <MapWrapper center={userLocation} zoom={15}>
              <LocationOnIcon lng={userLocation.lng} lat={userLocation.lat} />
            </MapWrapper>
          )}
          {!userInfo?.latitude && !userInfo?.longitude && (
